...
const Topbar = ({
  ...
  return (
    <div className="w-screen fixed inset-0 h-20 sm:h-24 md:h-28 lg:h-32 bg-background flex items-center justify-between px-4 sm:px-6 lg:px-16 z-100">
      {showBackButton ? (
        <button
      ...
      <h1 className="text-black font-bold text-lg sm:text-xl md:text-2xl lg:text-4xl absolute left-1/2 transform -translate-x-1/2 max-w-[60%] sm:max-w-none truncate text-center">
        {title}
      </h1>
