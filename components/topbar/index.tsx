...
const Topbar = ({
  ...
  return (
    <div className={`w-screen fixed top-0 left-0 h-20 sm:h-24 md:h-28 lg:h-32 ${isTransparentBg ? 'bg-transparent' : 'bg-background'} flex items-center justify-between px-4 sm:px-6 lg:px-16 z-100`}>
      {showBackButton ? (
        <button
        ...
        <div className="w-8 sm:w-10 lg:w-14" />
      )}
