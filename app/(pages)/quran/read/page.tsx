    ...
    <div className="w-full min-h-[82svh] overflow-x-hidden">
      ...
      {showSettings && (
        <div className="fixed inset-0 bg-black/50 z-200 flex items-end lg:items-center justify-center">
          <div className="bg-white w-full lg:w-125 lg:rounded-2xl rounded-t-3xl max-h-[80vh] sm:max-h-[75vh] overflow-auto">
            {/* Header */}
            ...
            <div className="p-4 sm:p-5 space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-100 rounded-xl p-3 sm:p-4 mb-3 sm:mb-4">
                  <p
                    className="font-arabic text-black text-center"
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <input
                    ...
                    className="flex-1 accent-[#E37100]"
                  />
              ...
              <div>
                ...
                <div className="bg-gray-100 rounded-xl p-3 sm:p-4 mb-3 sm:mb-4">
                  <p
                    className="font-arabic text-black text-center"
                    style={{ wordSpacing: `${wordSpacing}px`, fontSize: "24px" }}
                  >
                    بِسْمِ اللَّهِ
                  </p>
                </div>
